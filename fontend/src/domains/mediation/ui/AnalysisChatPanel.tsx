...
export interface AnalysisChatPanelProps {
  ...
  /** commit 成功后的回调 */
  onCommitted: (data: { sessionId: string; eventId: string; status: string; snapshotAId?: string | null; snapshotBId?: string | null; judgeResultId?: string | null }) => void;
  /** commit 按钮文案 */
  commitLabel?: string;
  /** 输入框 placeholder */
  ...
  const commitMutation = useMutation({
    ...
    onSuccess: (data) => {
      onCommitted({
        ...
        judgeResultId: data.judgeResultId,
      });
    },
  });
